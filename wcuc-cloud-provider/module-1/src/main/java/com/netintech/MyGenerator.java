...
/**
 * @Author: xuxiang
 * @Description: mybatisPlus模板生成方法
 * @Date: Create in 2018/10/25 9:11
 */
...
//        //mysql================
        ...
        dsc.setUrl("jdbc:mysql://192.168.56.5:3306/logs?useUnicode=true&characterEncoding=utf8&serverTimezone=GMT%2B8");
...
//        dsc.setUsername("NETINRECORD");
//        dsc.setPassword("netintech");
//        dsc.setUrl("jdbc:oracle:thin:@192.168.168.128:1521:orcl");
