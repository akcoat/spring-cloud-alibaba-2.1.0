...
public class MyGenerator {
    ...
    private static String packageName = "com.zhu";  //模块名称
    private static String modelName = "User";    //模块名称
    private static String authorName = "zjw";     //作者
    private static String[] includeTableNames = new String[]{"user_0"}; //需要生成的表名字
...
//        //mysql================
        ...
        dsc.setUrl("jdbc:mysql://192.168.56.5:3307/db0?characterEncoding=utf8&useSSL=false");
